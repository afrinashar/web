...
const Events = () => {
  return (
    <>
      <Container className="text-secondary"><Row className="m-4 p-2"><h2>Upcoming events by SSINTEK</h2><div className="grad"></div>Our upcoming events offer a chance to learn about the latest trends, explore new technologies, and network with professionals from across your industry</Row>
        <Row>
          ...
          <Row className="p-3 m-4"><h2>Past events by SSINTEK</h2>
